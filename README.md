...
| Quick diamond · 25s | Hard-earned diamond · 54s | A fatal shoreline fight · 59s |
|---|---|---|
| ![Diamond collected at action 67](docs/assets/easy-diamond.gif) | ![A long hunt ending in diamond at action 1862](docs/assets/long-diamond-hunt.gif) | ![The agent dies fighting along a narrow shoreline](docs/assets/shoreline-death.gif) |
| Diamond in 67 actions. | Diamond in 1,862 actions, after mining 87 stone, eating 9 cows and waking 17 times. | The full 489-action game, ending in a shoreline fight. |

Selected examples of the unchanged agent. Each shows its playback rate;
diamond collection and the final fight play at 3 actions/sec.
[Seeds, recording details and how to make these GIFs](docs/GAMEPLAY.md).
...
- [Controller and RGB decoder](src/crafter_symbolic/_policy/) ·
  [Code map](docs/CODE_MAP.md) · [How they work](docs/ARCHITECTURE.md).
...
- [Results and uncertainty](docs/BENCHMARKS.md) ·
  [Experiments and mistakes](docs/AUDIT.md) · [Final input audit](docs/FINAL_INPUT_AUDIT.md).
